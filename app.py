...
if 'conversations' not in st.session_state:
    st.session_state.conversations = {
        "محمد": [
            ...
            {"sender": "أحمد", "message": "أهلاً، أنا بخير الحمدلله. وأنت؟", "time": "10:31 ص"},
            {"sender": "محمد", "message": "بخير أيضاً، شكراً لك", "time": "10:32 ص"}
        ],
        "فاطمة": [
            {"sender": "فاطمة", "message": "هل انتهيت من التقرير؟", "time": "09:15 ص"},
            {"sender": "أحمد", "message": "نعم، سأرسله لك الآن", "time": "09:20 ص"}
        ],
        "خالد": [
            {"sender": "أحمد", "message": "هل نلتقي اليوم؟", "time": "أمس 08:30 م"},
            {"sender": "خالد", "message": "نعم، في المقهى المعتاد", "time": "أمس 08:35 م"}
        ],
        "سارة": [
            {"sender": "سارة", "message": "شكراً على المساعدة", "time": "الجمعة 03:45 م"},
            {"sender": "أحمد", "message": "العفو، دائماً في الخدمة", "time": "الجمعة 03:50 م"}
        ]
    }
